...
# Flag to select the read representation to be used.
...
# Do not change this, as the code is transitioning 
# to always use the run-length representation.
...
superBubbleLengthThreshold = 100
